...
func GetQrCodePath() string {
	return global.GINBASE_CONFIG.App.QrCodeSavePath
}

// GetQrCodeFullPath get full save path
func GetQrCodeFullPath() string {
	return global.GINBASE_CONFIG.App.RuntimeRootPath + global.GINBASE_CONFIG.App.QrCodeSavePath
}

// GetQrCodeFullUrl get the full access path
func GetQrCodeFullUrl(name string) string {
	return global.GINBASE_CONFIG.App.PrefixUrl + "/" + GetQrCodePath() + name
}
