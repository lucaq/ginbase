...
func SetupLogger() *zap.SugaredLogger {
	filepath := global.GINBASE_CONFIG.Zap.LogFilePath
	infofilename := global.GINBASE_CONFIG.Zap.LogInfoFileName
	warnfilename := global.GINBASE_CONFIG.Zap.LogWarnFileName
	fileext := global.GINBASE_CONFIG.Zap.LogFileExt
