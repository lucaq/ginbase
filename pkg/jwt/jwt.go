...
func Setup() {
	jwtSecret = []byte(global.GINBASE_CONFIG.App.JwtSecret)
}

func GenerateAppToken(m *models.GinbaseUser, d time.Time) (string, error) {
	m.Password = ""
...
//返回 detail user
func GetAppDetailUser(c *gin.Context) (*models.GinbaseUser, error) {
